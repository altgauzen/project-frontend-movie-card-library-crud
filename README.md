# project-frontend-movie-card-library-crud

## Meus Comentários

Este foi um projeto individual feito na Trybe no Módulo de Front-end onde aprendi sobre Ciclo de Vida de Componentes e React Router.
